    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Обязательное. 150 знаков или менее. Допустимы буквы, цифры и @/./+/-/_.', max_length=150, unique=True, validators=[django.core.validators.RegexValidator(message='Использованы запрещённые символы!', regex='^[\\w.@+-]+\\Z'), users.validators.check_me_name], verbose_name='Никнейм пользователя')),
